...
public class Practica2 extends javax.swing.JFrame {
    ...
    public Practica2() {
        initComponents();
        jdbc = new AccesoJDBC();
        String[] oficios = jdbc.getOficios();
        for (int i = 0; i < oficios.length; i++){
            this.combo_oficio.addItem(oficios[i]);
        }
    }
    ...
    private void initComponents() {
        ...
        label_oficio = new javax.swing.JLabel();
    ...
    private void combo_oficioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_combo_oficioActionPerformed
        ...
        String[] datos = jdbc.selPorOficio((String)this.combo_oficio.getSelectedItem());
        for (int i = 0; i < datos.length; i++){
            this.textArea.append(datos[i] + "\n");
        }
    ...
    private javax.swing.JLabel label_oficio;
